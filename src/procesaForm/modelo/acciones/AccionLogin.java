...
import procesaForm.bbdd.*;

/**
 * Encapsula la acción de loguearse
 */
public class AccionLogin implements Accion {
	 ...
	 */
	private final String vistaOK = "WEB-INF/datosUsuario.jsp";
	...
	public boolean ejecutar(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			beanDAO.getConexion();
			this.modelo = beanDAO.getUsuario(login, clave);
			beanDAO.close();
